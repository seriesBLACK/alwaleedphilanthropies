    ...
    <div className="flex flex-col gap-5 items-center justify-center min-h-screen bg-[#013a19] text-white p-4">
      ...
      <div className="rounded-lg p-8 max-w-md w-full text-center border">
        ...
        <div className="flex justify-center gap-5">
          ...
          <a href="" target="_blank" rel="noopener noreferrer" aria-label="Gmail" className="bg-gray-500 rounded-2xl p-3">
          ...
          <a href="" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="bg-gray-500 rounded-2xl p-3">
