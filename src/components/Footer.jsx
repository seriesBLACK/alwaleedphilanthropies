...
export default function Footer() {
  return (
    <section id="footer" className="h-screen w-full flex flex-col z-10">
      <div className="flex flex-col gap-5 w-full px-4 sm:pt-10 lg:flex-row lg:px-25 flex-1 overflow-auto">
        ...
        <div className="w-full h-[50%] z-10 lg:w-[55%] lg:h-full">
          ...
          <a href="/complain" className="w-full flex justify-center">
            <button className="py-5 px-10 my-5 flex items-center gap-1.5 bg-[#25698d] rounded-2xl text-white text-2xl">
