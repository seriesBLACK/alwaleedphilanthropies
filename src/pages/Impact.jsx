    ...
    <div dir="rtl">
      ...
      <main className="w-full mx-auto mt-22 px-3 lg:px-29 lg:py-12 py-1 z-10 bg-white/900">
        <div className=" w-full lg:w-[50%]">
          <h1 className="text-3xl md:text-5xl leading-[1.2]">مجالات عملنا</h1>
          <p className="mt-4 text-lg md:text-xl">لا يهمنا أين كان التحدي أو مدى صعوبته، ما نهتم به هو الخير للإنسانية في المدى البعيد.</p>
        </div>
